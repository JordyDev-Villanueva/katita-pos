"""
Script de migracion para actualizar el constraint de estado en cuadros_caja
...
def update_estado_constraint():
    ...
    with app.app_context():
        try:
            print("Iniciando actualizacion de constraint de estado...")
