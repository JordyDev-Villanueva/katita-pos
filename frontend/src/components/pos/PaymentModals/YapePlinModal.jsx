  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4">
        {/* Header */}
        <div className={`${bgColor} text-white p-6 rounded-t-2xl`}>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className={`text-${color}-100 text-sm`}>Escanea el código QR</p>
              </div>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          ...
          {/* QR Code */}
          <div className={`border-4 ${borderColor} rounded-2xl p-4 bg-white`}>
          ...
          {/* Instrucciones */}
          <div className={`bg-${color}-50 border ${borderColor} rounded-xl p-4`}>
